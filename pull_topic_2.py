...
def callback(message):
    ...
    try:
        ...
        logging.info("Executing Sentiment Analysis")
        ...
        client = storage.Client.from_service_account_json('credentials.json')  # Replace with your credentials path
        
        bucket_name = 'data_eng2_bucket'  # Replace with your bucket name
        destination_blob_name = 'final_product.csv'  # Replace with the desired destination and file name
...
def main():
    ...
    sys.exit(0)  # Exit the process once subscription is exhausted or error occurs
